...
func newTodo(db *gorm.DB, opts ...gen.DOOption) todo {
	...
	_todo.todoDo.UseModel(&tenant.Todo{})
	...
	_todo.IsDeleted = field.NewBool(tableName, "is_deleted")
...
type ITodoDo interface {
	...
	Unscoped() ITodoDo
	Create(values ...*tenant.Todo) error
	CreateInBatches(values []*tenant.Todo, batchSize int) error
	Save(values ...*tenant.Todo) error
	First() (*tenant.Todo, error)
	Take() (*tenant.Todo, error)
	Last() (*tenant.Todo, error)
	Find() ([]*tenant.Todo, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Todo, err error)
	FindInBatches(result *[]*tenant.Todo, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*tenant.Todo) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*tenant.Todo, error)
	FirstOrCreate() (*tenant.Todo, error)
	FindByPage(offset int, limit int) (result []*tenant.Todo, count int64, err error)
...
func (t todoDo) Create(values ...*tenant.Todo) error {
	if len(values) == 0 {
		return nil
	}
...
func (t todoDo) CreateInBatches(values []*tenant.Todo, batchSize int) error {
	return t.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (t todoDo) Save(values ...*tenant.Todo) error {
	if len(values) == 0 {
		return nil
	}
...
func (t todoDo) First() (*tenant.Todo, error) {
	if result, err := t.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*tenant.Todo), nil
	}
}

func (t todoDo) Take() (*tenant.Todo, error) {
...
func (t todoDo) Last() (*tenant.Todo, error) {
...
func (t todoDo) Find() ([]*tenant.Todo, error) {
	result, err := t.DO.Find()
	return result.([]*tenant.Todo), err
}

func (t todoDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Todo, err error) {
	buf := make([]*tenant.Todo, 0, batchSize)
...
func (t todoDo) FindInBatches(result *[]*tenant.Todo, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (t todoDo) FirstOrInit() (*tenant.Todo, error) {
...
func (t todoDo) FirstOrCreate() (*tenant.Todo, error) {
...
func (t todoDo) FindByPage(offset int, limit int) (result []*tenant.Todo, count int64, err error) {
...
func (t todoDo) Delete(models ...*tenant.Todo) (result gen.ResultInfo, err error) {
