...
func newMigration(db *gorm.DB, opts ...gen.DOOption) migration {
	...
	_migration.migrationDo.UseModel(&tenant.Migration{})
...
type IMigrationDo interface {
	...
	Create(values ...*tenant.Migration) error
	CreateInBatches(values []*tenant.Migration, batchSize int) error
	Save(values ...*tenant.Migration) error
	First() (*tenant.Migration, error)
	Take() (*tenant.Migration, error)
	Last() (*tenant.Migration, error)
	Find() ([]*tenant.Migration, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Migration, err error)
	FindInBatches(result *[]*tenant.Migration, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*tenant.Migration) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*tenant.Migration, error)
	FirstOrCreate() (*tenant.Migration, error)
	FindByPage(offset int, limit int) (result []*tenant.Migration, count int64, err error)
...
func (m migrationDo) Create(values ...*tenant.Migration) error {
	if len(values) == 0 {
		return nil
	}
...
func (m migrationDo) CreateInBatches(values []*tenant.Migration, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m migrationDo) Save(values ...*tenant.Migration) error {
	if len(values) == 0 {
		return nil
	}
...
func (m migrationDo) First() (*tenant.Migration, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*tenant.Migration), nil
	}
}

func (m migrationDo) Take() (*tenant.Migration, error) {
...
func (m migrationDo) Last() (*tenant.Migration, error) {
...
func (m migrationDo) Find() ([]*tenant.Migration, error) {
	result, err := m.DO.Find()
	return result.([]*tenant.Migration), err
}

func (m migrationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*tenant.Migration, err error) {
	buf := make([]*tenant.Migration, 0, batchSize)
...
func (m migrationDo) FindInBatches(result *[]*tenant.Migration, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m migrationDo) FirstOrInit() (*tenant.Migration, error) {
...
func (m migrationDo) FirstOrCreate() (*tenant.Migration, error) {
...
func (m migrationDo) FindByPage(offset int, limit int) (result []*tenant.Migration, count int64, err error) {
...
func (m migrationDo) Delete(models ...*tenant.Migration) (result gen.ResultInfo, err error) {
