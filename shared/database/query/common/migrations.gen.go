...
func newMigration(db *gorm.DB, opts ...gen.DOOption) migration {
	...
	_migration.migrationDo.UseModel(&common.Migration{})
...
type IMigrationDo interface {
	...
	Create(values ...*common.Migration) error
	CreateInBatches(values []*common.Migration, batchSize int) error
	Save(values ...*common.Migration) error
	First() (*common.Migration, error)
	Take() (*common.Migration, error)
	Last() (*common.Migration, error)
	Find() ([]*common.Migration, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*common.Migration, err error)
	FindInBatches(result *[]*common.Migration, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*common.Migration) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*common.Migration, error)
	FirstOrCreate() (*common.Migration, error)
	FindByPage(offset int, limit int) (result []*common.Migration, count int64, err error)
...
func (m migrationDo) Create(values ...*common.Migration) error {
	if len(values) == 0 {
		return nil
	}
...
func (m migrationDo) CreateInBatches(values []*common.Migration, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m migrationDo) Save(values ...*common.Migration) error {
	if len(values) == 0 {
		return nil
	}
...
func (m migrationDo) First() (*common.Migration, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*common.Migration), nil
	}
}

func (m migrationDo) Take() (*common.Migration, error) {
...
func (m migrationDo) Last() (*common.Migration, error) {
...
func (m migrationDo) Find() ([]*common.Migration, error) {
	result, err := m.DO.Find()
	return result.([]*common.Migration), err
}

func (m migrationDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*common.Migration, err error) {
	buf := make([]*common.Migration, 0, batchSize)
...
func (m migrationDo) FindInBatches(result *[]*common.Migration, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m migrationDo) FirstOrInit() (*common.Migration, error) {
...
func (m migrationDo) FirstOrCreate() (*common.Migration, error) {
...
func (m migrationDo) FindByPage(offset int, limit int) (result []*common.Migration, count int64, err error) {
...
func (m migrationDo) Delete(models ...*common.Migration) (result gen.ResultInfo, err error) {
